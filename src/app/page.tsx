    ...
    <Form>
        <Row>
			<Col>
				...
				<div>
					...
					<Form.Control type='number' name={"invoiceNumber"} />
				</div>
		...
		<Row>
			<Col>
                ...
                <Form.Control placeholder={"Who is this invoice to?"} rows={3} type="text" name="billTo" className="my-2"  autoComplete="name" required />
                <Form.Control placeholder={"Email address"}  type="email" name="billToEmail" className="my-2" autoComplete="email" required />
                <Form.Control placeholder={"Billing address"} type="text" name="billToAddress" className="my-2" autoComplete="address" required />
              </Col>
              <Col>
                <Form.Label className="fw-bold">Bill from:</Form.Label>
                <Form.Control placeholder={"Who is this invoice from?"} rows={3}  type="text" name="billFrom" className="my-2" autoComplete="name" required />
                <Form.Control placeholder={"Email address"} type="email" name="billFromEmail" className="my-2" autoComplete="email" required />
                <Form.Control placeholder={"Billing address"} type="text" name="billFromAddress" className="my-2" autoComplete="address" required  />
